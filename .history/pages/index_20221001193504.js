...
const Guild = (props) => {
  ...
  return (
    ...
    >
      ...
      <th className=' '>
        <div className=' bg-yellow-500 mx-6 my-1 font-normal rounded-md'>
          {guildJson.members}
        </div>
      </th>
      <th>
        ...
        >
          <div className={`font-normal my-1 ${weightColor} rounded-md`}>
      ...
      <th>
        ...
        >
          <div className={`my-1 mx-3 font-normal bg-blue-700 rounded-md`}>
      ...
      <th className='hidden md:table-cell'>
        ...
        >
          <div className='my-1 mx-10 font-normal bg-blue-500 rounded-md'>
            {guildJson.skills}
          </div>
        </Tippy>
      </th>
      <th className='hidden md:table-cell'>
        ...
        >
          <div className='my-1 mx-2 font-normal bg-red-500 rounded-md'>
      ...
      <th className='hidden md:table-cell'>
        ...
        >
          <div className='my-1 mx-6 font-normal bg-green-400 rounded-md'>
            {guildJson.catacombs}
          </div>
        </Tippy>
      </th>
...
const Guilds = (props) => {
  ...
  return (
    <table className='text-white bg-primary text-center rounded-md w-[90%] text-[0.6em] xs:text-[0.8em] sm:text-base md:text-sm lg:text-[1rem] xl:w-4/5 2xl:text-xl mx-auto'>
      <tbody>
        <tr>
          <th className='pl-1 md:pl-6 text-2xl'>#</th>
          <th></th>
          <th></th>
          <th className='tracking-[.1em] text-left text-2xl'>Guilds</th>
          <th
          ...
          <th
            className='hover:cursor-pointer hidden md:table-cell text-2xl'
            onClick={() => {
              onSortClick('skills');
            }}
          >
          ...
          <th className='hidden lg:table-cell text-2xl'>Last updated</th>
        </tr>
        {guilds}
      </tbody>
    </table>
