...
const Guild = (props) => {
  ...
  return (
    ...
    >
      ...
      <th className=' '>
        <div className=' bg-yellow-500 mx-6 my-1 px-1 font-normal rounded-md'>
          {guildJson.members}
        </div>
      </th>
      <th>
        ...
        >
          <div className={`font-normal my-1 ${weightColor} rounded-md px-1`}>
      ...
      <th>
        ...
        >
          <div className={`my-1 mx-3 font-normal bg-blue-700 rounded-md px-1`}>
      ...
      <th className='hidden md:table-cell'>
        ...
        >
          <div className='my-1 mx-10 font-normal bg-blue-500 rounded-md px-1'>
            {guildJson.skills}
          </div>
        </Tippy>
      </th>
      <th className='hidden md:table-cell'>
        ...
        >
          <div className='my-1 mx-2 font-normal bg-red-500 rounded-md px-1'>
      ...
      <th className='hidden md:table-cell'>
        ...
        >
          <div className='my-1 mx-6 font-normal bg-green-400 rounded-md px-1'>
            {guildJson.catacombs}
          </div>
        </Tippy>
      </th>
