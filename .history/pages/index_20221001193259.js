...
const Guilds = (props) => {
  ...
  return (
    <table className='text-white bg-primary text-center rounded-md w-[90%] text-2xl xs:text-[0.8em] sm:text-base md:text-sm lg:text-[1rem] xl:w-4/5 2xl:text-xl mx-auto'>
      <tbody>
        <tr>
