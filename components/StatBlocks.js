...
export const MenuButton = (props) => {
    return (
        <button className={`${props.className} relative inline-flex items-center justify-center px-6 py-3 overflow-hidden text-white ${props.disabled ? 'bg-primary' : 'bg-lightprimary'} rounded-lg group`}
